...
export const updatePost = async (req, res) => {
     ...
     const updatedPost = {
          ...
          honrsName, honrsCertificate, honrsCGPA, honrsName1, honrsCertificate1, honrsCGPA1, workExperience1, workJoin1, workLeave1, workExperience2, workJoin2, workLeave2, skills, about, file, Facebook, linkedin, Skype, jobtitle, Interested, _id: id, ProjectOne, ProjectOneGit, ProjectTwo, ProjectTwoGit, ProjectThree, ProjectThreeGit, Salary, Website, Github, Job_type
     };
