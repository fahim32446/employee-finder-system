...
const Profile = ({ currentId, setCurrentId }) => {
  ...
  const [postData, setPostData] = useState({
    name: '', email: '', phone: '', address: '', dob: '', schoolName: '', schoolCertificate: '', schoolGpa: '', collageName: '', collageCertificate: '', collageGpa: '', Salary: '', honrsName: '', honrsCertificate: '', honrsCGPA: '', honrsName1: '', honrsCertificate1: '', honrsCGPA1: '', workExperience1: '', workJoin1: '', workLeave1: '', workExperience2: '', workJoin2: '', workLeave2: '', skills: [], about: '', file: '', Website: '', Github: '', Facebook: '', linkedin: '', Skype: '', jobtitle: '', Interested: '', ProjectOne: '', ProjectOneGit: '', ProjectTwo: '', ProjectTwoGit: '', ProjectThree: '', ProjectThreeGit: '', Job_type: ''
  });



  const chooseSkills = [
    "JavaScript", "ReactJs", "Css", "NodeJs", "ExpressJs", "Mongoose", "MySql", "Java", "C#", "C", "C+", "Php", "Laravel", "Wordpress", "Python", "Django", "CCNA", "Flutter", "Html", "Photoshop", "Lightroom", "PremierePro", "UI/UX", "Bootstrap", "Android Studio", "SQL", "AWS", "Data Analysis", "DevOps", "SEO", "AI", "UI/UX", "Angular", "TypeScript", "Illustrator", "Network Switches", "VueJs"
  ];
          ...
          <div className="col-md-3 border-right">
            ...
            <div className='mt-3'>
              ...
              <select id="job" name="jobtitle" value={postData.jobtitle} onChange={(e) => setPostData({ ...postData, jobtitle: e.target.value })} className="form-control custom-select bg-white border-left-0 border-md">
                ...
                <option value="App Developer">Android Developer</option>
          ...
          <div className="col-md-5 border-right">
            <div className="p-3 py-5">
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-4"><label className="labels">Certificates</label><input name="schoolCertificate" value={postData.schoolCertificate} onChange={(e) => setPostData({ ...postData, schoolCertificate: e.target.value })} type="text" className="form-control" placeholder='SSC' /></div>
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-4"><label className="labels">Certificates</label><input name="collageCertificate" value={postData.collageCertificate} onChange={(e) => setPostData({ ...postData, collageCertificate: e.target.value })} type="text" className="form-control" placeholder='JSC' /></div>
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-4"><label className="labels">Certificates</label><input name="honrsCertificate" value={postData.honrsCertificate} onChange={(e) => setPostData({ ...postData, honrsCertificate: e.target.value })} type="text" className="form-control" placeholder='B.Sc.' /></div>
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-4"><label className="labels">Institute Name</label><input name="honrsName" value={postData.honrsName1} onChange={(e) => setPostData({ ...postData, honrsName1: e.target.value })} type="text" className="form-control" /></div>

                <div className="col-md-4"><label className="labels">Certificates</label><input name="honrsCertificate" value={postData.honrsCertificate1} onChange={(e) => setPostData({ ...postData, honrsCertificate1: e.target.value })} type="text" className="form-control" placeholder='M.Sc.' /></div>

                <div className="col-md-4"><label className="labels">CGPA</label><input name="honrsCGPA" value={postData.honrsCGPA1} onChange={(e) => setPostData({ ...postData, honrsCGPA1: e.target.value })} type="text" className="form-control" /></div>
              </div>
