              ...
              <div className="col-md-4 mb-3">
                  ...
                  <div className="card-body">
                    <div className="d-flex flex-column align-items-center text-center">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="font-size-sm mb-2 badge bg-primary text-wrap" >{`Expected Salary: ${post.Salary}/tk`}</p> <br />
                ...
                <div className="card mt-3">
                  <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <h6 className="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-skype" viewBox="0 0 16 16">
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <h6 className="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                    ...
                    <div className="card h-100">
                      ...
                      <div className="card-body ">
                        ...
                        {post.skills.map((skill, index) => (
                          <li style={{ backgroundColor: '#ebb13471' }} class="d-inline-block rounded list-group-item m-1">{`${index + 1}. ${skill}`}</li>
                        ))}
